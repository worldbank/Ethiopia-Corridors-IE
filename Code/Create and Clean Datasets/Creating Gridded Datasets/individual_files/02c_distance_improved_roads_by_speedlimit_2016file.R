...
points_all <- pbmclapply(1997:2016, determine_distance_to_points, points, mc.cores=3) %>% bind_rows

# Export -----------------------------------------------------------------------
saveRDS(points_all, file.path(outputs_for_grid, TYPE, "points_distance_improved_roads_byspeed_2016file.Rds"))
