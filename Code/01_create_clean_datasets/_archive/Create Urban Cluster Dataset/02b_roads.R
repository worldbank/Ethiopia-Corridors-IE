...
points_all <- lapply(1996:2016, determine_distance_to_points, clumps_sp) %>% bind_rows

# Export -----------------------------------------------------------------------
saveRDS(points_all, file.path(finaldata_file_path, "urban_cluster_dataset", "individual_files", "urban_cluster_distance_roads_byspeed_2016file.Rds"))
