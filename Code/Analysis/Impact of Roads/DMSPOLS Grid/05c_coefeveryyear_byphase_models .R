...
# Load Data --------------------------------------------------------------------
results_all <- readRDS(file.path(finaldata_file_path, "lead_lag_results_coefficients", "results_by_phase_5percent_diff.Rds"))
results_all <- results_all[grepl("years_since_improved", results_all$variable),]
