...
# Placebo treatment
data$years_since_improved_all_placebo <- data$years_since_improved_all
data$years_since_improved_50above_placebo <- data$years_since_improved_50above
data$years_since_improved_below50_placebo <- data$years_since_improved_below50
...
if(grepl("points", dataset)){
  ...
  stargazer(felm_allroads,
            ...
            felm_blabv50roads_ntlbase_urban,
            dep.var.labels.include = T,
            dep.var.labels = c("DMSP-OLS","Proportion Urban"),
            dep.var.caption = "",
            covariate.labels = covariate.labels,
            omit.stat = c("f","ser"),
            align=TRUE,
            ...
            stargazer(felm_allroads_dmspols1,
                      ...
                      felm_blabv50roads_ntlbase_dmspols5,
                      dep.var.labels.include = T,
                      dep.var.labels = c("DMSP-OLS $>$ 0","DMSP-OLS $>$ 5"),
                      dep.var.caption = "",
                      covariate.labels = covariate.labels,
                      omit.stat = c("f","ser"),
                      align=TRUE,
