...
# Export -----------------------------------------------------------------------
saveRDS(dmspols_points, file.path(panel_rsdp_imp_data_file_path, "dmspols_grid_nearroad", "individual_datasets","points.Rds"))
saveRDS(dmspols_poly,   file.path(panel_rsdp_imp_data_file_path, "dmspols_grid_nearroad", "individual_datasets","polygons.Rds"))
