...
data <- data %>%
  ...
  dplyr::mutate(improved_all_p1 = max(near_improved_all[year %in% 1997:2002], na.rm=T)) %>%
  dplyr::mutate(improved_50above_p1 = max(near_improved_50above[year %in% 1997:2002], na.rm=T)) %>%
  dplyr::mutate(improved_below50_p1 = max(near_improved_below50[year %in% 1997:2002], na.rm=T)) %>%
  
  dplyr::mutate(improved_all_p2 = max(near_improved_all[year %in% 2003:2007], na.rm=T)) %>%
  dplyr::mutate(improved_50above_p2 = max(near_improved_50above[year %in% 2003:2007], na.rm=T)) %>%
  dplyr::mutate(improved_below50_p2 = max(near_improved_below50[year %in% 2003:2007], na.rm=T)) %>%
  
  dplyr::mutate(improved_all_p3 = max(near_improved_all[year %in% 2008:2010], na.rm=T)) %>%
  dplyr::mutate(improved_50above_p3 = max(near_improved_50above[year %in% 2008:2010], na.rm=T)) %>%
  dplyr::mutate(improved_below50_p3 = max(near_improved_below50[year %in% 2008:2010], na.rm=T)) %>%
  
  dplyr::mutate(dmspols_1997 = dmspols[year == 1997]) %>%
  
  ungroup()

data <- data[(data$improved_all_p1 %in% 1) | (data$improved_all_p2 %in% 1) | (data$improved_all_p3 %in% 1),]

data$improved_all_p2 <- data$improved_all_p2*2
data$improved_50above_p2 <- data$improved_50above_p2*2
data$improved_below50_p2 <- data$improved_below50_p2*2

data$improved_all_p3 <- data$improved_all_p3*3
data$improved_50above_p3 <- data$improved_50above_p3*3
data$improved_below50_p3 <- data$improved_below50_p3*3

data$improved_all_p123 <- paste0(data$improved_all_p1, data$improved_all_p2, data$improved_all_p3) %>% str_replace_all("0", "") %>% as.factor

#data$improved_all_p1[data$year %in% c(2003:2007, 2008:2010)] <- 0
#data$improved_50above_p1[data$year %in% c(2003:2007, 2008:2010)] <- 0
#data$improved_below50_p1[data$year %in% c(2003:2007, 2008:2010)] <- 0

#data$improved_all_p2[data$year %in% c(1997:2002, 2008:2010)] <- 0
#data$improved_50above_p2[data$year %in% c(1997:2002, 2008:2010)] <- 0
#data$improved_below50_p2[data$year %in% c(1997:2002, 2008:2010)] <- 0

#data$improved_all_p3[data$year %in% c(1997:2002, 2003:2007)] <- 0
#data$improved_50above_p3[data$year %in% c(1997:2002, 2003:2007)] <- 0
#data$improved_below50_p3[data$year %in% c(1997:2002, 2003:2007)] <- 0
...
# Regressions ------------------------------------------------------------------
felm_dmspols <- felm(dmspols_zhang ~ improved_all_p123 | year | 0 | GADM_ID_3, data=data[data$year <= 2012,])
felm_dmspols1 <- felm(dmspols_zhang_1 ~ improved_all_p123 | year | 0 | GADM_ID_3, data=data[data$year <= 2012,])
felm_dmspols5 <- felm(dmspols_zhang_5 ~ improved_all_p123 | year | 0 | GADM_ID_3, data=data[data$year <= 2012,])
felm_urban <- felm(globcover_urban ~ improved_all_p123 | year | 0 | GADM_ID_3, data=data[data$year <= 2012,])

stargazer(felm_dmspols,
          felm_dmspols1,
          felm_dmspols5,
          felm_urban,
          ...
          dep.var.caption = "",
          covariate.labels = c("Near Rd Impr in Phase 1 and 2",
                               "Near Rd Impr in Phase 1, 2 and 3",
                               "Near Rd Impr in Phase 1 and 3",
                               "Near Rd Impr in Phase 2",
                               "Near Rd Impr in Phase 2 and 3",
                               "Near Rd Impr in Phase 3"),
          omit.stat = c("f","ser"),
          align=TRUE,
          no.space=TRUE,
          float=FALSE,
          ...
          out = file.path(tables_file_path, paste0("did_",dataset,
                                                   ".tex")))


summary(felm_dmspols)
summary(felm_dmspols_road50)
summary(felm_dmspols_basentl)

data$years_since_improved_all_p2 %>% table

# Constant Sample --------------------------------------------------------------
#year_improved_begin <- 2002
#year_improved_end <- 2008
#years_since_improved_begin <- 1997 - year_improved_begin
#years_since_improved_end <- 2012 - year_improved_end

#data_improved_all <- data[!is.na(data$year_improved_all),]
#data_improved_all <- data_improved_all[data_improved_all$year_improved_all >= year_improved_begin & data_improved_all$year_improved_all <= year_improved_end,]
#data_improved_all <- data_improved_all[data_improved_all$years_since_improved_all >= years_since_improved_begin & data_improved_all$years_since_improved_all <= years_since_improved_end,]

#data_improved_50above <- data[!is.na(data$year_improved_50above),]
#data_improved_50above <- data_improved_50above[data_improved_50above$year_improved_50above >= year_improved_begin & data_improved_50above$year_improved_50above <= year_improved_end,]
#data_improved_50above <- data_improved_50above[data_improved_50above$years_since_improved_50above >= years_since_improved_begin & data_improved_50above$years_since_improved_50above <= years_since_improved_end,]

#data_improved_below50 <- data[!is.na(data$year_improved_below50),]
#data_improved_below50 <- data_improved_below50[data_improved_below50$year_improved_below50 >= year_improved_begin & data_improved_below50$year_improved_below50 <= year_improved_end,]
#data_improved_below50 <- data_improved_below50[data_improved_below50$years_since_improved_below50 >= years_since_improved_begin & data_improved_below50$years_since_improved_below50 <= years_since_improved_end,]

#data_improved_all$years_since_improved_all %>% table
#data_improved_50above$years_since_improved_50above %>% table
#data_improved_below50$years_since_improved_below50 %>% table
