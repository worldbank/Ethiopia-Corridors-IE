  ...
  for(dv in c("globcover_urban_sum_ihs", "dmspols_zhang_sum2_ihs", "dmspols_zhang_sum6_ihs", "dmspols_zhang_ihs", "dmspols_zhang_sum_ihs")){
    for(log in c("_log")){
      for(theta in c("1", "3_8", "8")){ # 2, 5
        ...
        for(MA_ubanrural in c("", "_urban2", "_rural2")){ # "_urban2", "_rural2"
          ...
          data_MAall$MA_var      <- data_MAall[[paste0("MA_pop2000_tt_theta",theta, MA_ubanrural, log)]]
          data_MAall$MA_var_1996 <- data_MAall[[paste0("MA_pop2000_tt_theta",theta, MA_ubanrural, log, "_1996")]]
          
          data_MAall$MA_var_exc      <- data_MAall[[paste0("MA_pop2000_tt_theta",theta, "_exclude50km", MA_ubanrural, log)]]
          data_MAall$MA_var_exc_1996 <- data_MAall[[paste0("MA_pop2000_tt_theta",theta, "_exclude50km", MA_ubanrural, log, "_1996")]]
          
          data_MAexc$MA_var      <- data_MAexc[[paste0("MA_pop2000_tt_theta",theta,"_exclude50km", MA_ubanrural, log)]]
          data_MAexc$MA_var_1996 <- data_MAexc[[paste0("MA_pop2000_tt_theta",theta,"_exclude50km", MA_ubanrural, log, "_1996")]]
