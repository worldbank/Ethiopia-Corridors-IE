...
lm_dmspols_zhang_ihs_basentl <- felm(dmspols_zhang_ihs ~ near_anyimproved_5km + near_mst_5kmXdmspols_zhang_ihs_1996_woreda | 0 | 0 | W_CODE, data = df2012)
lm_dmspols_zhang_2_basentl   <- felm(dmspols_zhang_2   ~ near_anyimproved_5km + near_mst_5kmXdmspols_zhang_ihs_1996_woreda | 0 | 0 | W_CODE, data = df2012)
lm_dmspols_zhang_6_basentl   <- felm(dmspols_zhang_6   ~ near_anyimproved_5km + near_mst_5kmXdmspols_zhang_ihs_1996_woreda | 0 | 0 | W_CODE, data = df2012)
lm_globcover_urban_basentl   <- felm(globcover_urban   ~ near_anyimproved_5km + near_mst_5kmXdmspols_zhang_ihs_1996_woreda | 0 | 0 | W_CODE, data = df2016)
...
iv_cd_dmspols_zhang_ihs_basentl <- felm(dmspols_zhang_ihs ~ 1 | 0 | (near_anyimproved_5km|near_anyimproved_5kmXdmspols_zhang_ihs_1996_woreda ~ near_mst_5km + near_mst_5kmXdistance_city_addisababa) | W_CODE, data = df2012)
iv_cd_dmspols_zhang_2_basentl   <- felm(dmspols_zhang_2   ~ 1 | 0 | (near_anyimproved_5km|near_anyimproved_5kmXdmspols_zhang_ihs_1996_woreda ~ near_mst_5km + near_mst_5kmXdistance_city_addisababa) | W_CODE, data = df2012)
iv_cd_dmspols_zhang_6_basentl   <- felm(dmspols_zhang_6   ~ 1 | 0 | (near_anyimproved_5km|near_anyimproved_5kmXdmspols_zhang_ihs_1996_woreda ~ near_mst_5km + near_mst_5kmXdistance_city_addisababa) | W_CODE, data = df2012)
iv_cd_globcover_urban_basentl   <- felm(globcover_urban   ~ 1 | 0 | (near_anyimproved_5km|near_anyimproved_5kmXdmspols_zhang_ihs_1996_woreda ~ near_mst_5km + near_mst_5kmXdistance_city_addisababa) | W_CODE, data = df2016)
...
iv_ld_dmspols_zhang_ihs_basentl <- felm(dmspols_zhang_ihs ~ 1 | 0 | (near_anyimproved_5km|near_anyimproved_5kmXdmspols_zhang_ihs_1996_woreda ~ near_mst_mindist_5km + near_mst_mindist_5kmXdistance_city_addisababa) | W_CODE, data = df2012)
iv_ld_dmspols_zhang_2_basentl   <- felm(dmspols_zhang_2   ~ 1 | 0 | (near_anyimproved_5km|near_anyimproved_5kmXdmspols_zhang_ihs_1996_woreda ~ near_mst_mindist_5km + near_mst_mindist_5kmXdistance_city_addisababa) | W_CODE, data = df2012)
iv_ld_dmspols_zhang_6_basentl   <- felm(dmspols_zhang_6   ~ 1 | 0 | (near_anyimproved_5km|near_anyimproved_5kmXdmspols_zhang_ihs_1996_woreda ~ near_mst_mindist_5km + near_mst_mindist_5kmXdistance_city_addisababa) | W_CODE, data = df2012)
iv_ld_globcover_urban_basentl   <- felm(globcover_urban   ~ 1 | 0 | (near_anyimproved_5km|near_anyimproved_5kmXdmspols_zhang_ihs_1996_woreda ~ near_mst_mindist_5km + near_mst_mindist_5kmXdistance_city_addisababa) | W_CODE, data = df2016)
...
stargazer(lm_dmspols_zhang_ihs,
          ...
          dep.var.labels = c("NTL (IHS)", "NTL $>$ 2", "NTL $>$ 6", "Urban",
                             "NTL (IHS)", "NTL $>$ 2", "NTL $>$ 6", "Urban",
                             "NTL (IHS)", "NTL $>$ 2", "NTL $>$ 6", "Urban"),
          dep.var.caption = "",
          covariate.labels = c("Near Improved Rd.",
                               "Near Improved Rd. X Dist Addis",
                               "Near Improved Rd. X NTL 1996"),
          omit.stat = c("f","ser"),
          align=TRUE,
          no.space=TRUE,
          float=FALSE,
