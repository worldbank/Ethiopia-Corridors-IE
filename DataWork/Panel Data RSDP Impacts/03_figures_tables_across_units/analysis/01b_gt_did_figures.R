...
make_1_figure <- function(ntl_group_i,
  ...
  if(ntl_group_i %in% "low") title <- paste0(title, "Below Median Baseline Nighttime Lights")
  if(ntl_group_i %in% "high") title <- paste0(title, "Above Median Baseline Nighttime Lights")
