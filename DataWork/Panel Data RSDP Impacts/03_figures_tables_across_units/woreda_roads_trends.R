...
data_yr_long %>%
  ...
  ggsave(filename = file.path(paper_figures, "road_speed_byYear_byWoredaNTL.png"),
         height = 4, width = 6)
...
data_yr_long %>%
  ...
  facet_wrap(~speed_name,
             scale = "free_y",
             nrow = 1) +
  ggsave(filename = file.path(paper_figures, "roadLengthAbove_bySpeed_byWoredaNTL.png"),
         height = 3, width = 10)
