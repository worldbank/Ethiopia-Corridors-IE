...
data_append <- readRDS(file.path(panel_rsdp_imp_data_file_path, "dmspols_grid_nearroad", "merged_datasets", "grid_data_clean.Rds"))

lm1 <- lm(dmspols ~ years_since_improvedroad, data = data_append)
