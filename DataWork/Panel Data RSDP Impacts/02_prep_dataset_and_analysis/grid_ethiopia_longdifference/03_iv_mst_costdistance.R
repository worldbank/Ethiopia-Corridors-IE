...
# Estimate Models --------------------------------------------------------------
## 2012 as Endline
iv_dmspols_zhang_ihs         <- felm(dmspols_zhang_ihs         ~ 1 | 0 | (near_anyimproved_5km ~ near_mst_5km) | W_CODE, data = df2012)
iv_dmspols_zhang_ihs_base0na <- felm(dmspols_zhang_ihs_base0na ~ 1 | 0 | (near_anyimproved_5km ~ near_mst_5km) | W_CODE, data = df2012)
iv_dmspols_zhang_2           <- felm(dmspols_zhang_2           ~ 1 | 0 | (near_anyimproved_5km ~ near_mst_5km) | W_CODE, data = df2012)
iv_dmspols_zhang_6           <- felm(dmspols_zhang_6           ~ 1 | 0 | (near_anyimproved_5km ~ near_mst_5km) | W_CODE, data = df2012)

## 2016 as Endline
iv_globcover_urban    <- felm(globcover_urban    ~ 1 | 0 | (near_anyimproved_5km ~ near_mst_5km) | W_CODE, data = df2016)
iv_globcover_cropland <- felm(globcover_cropland ~ 1 | 0 | (near_anyimproved_5km ~ near_mst_5km) | W_CODE, data = df2016)
iv_ndvi               <- felm(ndvi               ~ 1 | 0 | (near_anyimproved_5km ~ near_mst_5km) | W_CODE, data = df2016)
iv_ndvi_cropland      <- felm(ndvi_cropland      ~ 1 | 0 | (near_anyimproved_5km ~ near_mst_5km) | W_CODE, data = df2016)
...
stargazer(iv_dmspols_zhang_ihs,
          ...
          out = file.path(panel_rsdp_imp_data_file_path, 
                          ...
                          "outputs",
                          "tables",
                          "iv_near_mst_costdistance_5km_results.tex"))
...
stargazer(iv_dmspols_zhang_ihs$stage1,
          ...
          out = file.path(panel_rsdp_imp_data_file_path, 
                          ...
                          "outputs",
                          "tables",
                          "iv_near_mst_costdistance_5km_1stage_results.tex"))
