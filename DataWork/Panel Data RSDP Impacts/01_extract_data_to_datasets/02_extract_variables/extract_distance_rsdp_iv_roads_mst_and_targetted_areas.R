...
# points$distance_rsdp123_mst_euc_region <- gDistance_chunks(points, mst_euc_dist,       CHUNK_SIZE_DIST_ROADS, MCCORS_DIST_ROADS)
# points$distance_rsdp123_mst_lc_region  <- gDistance_chunks(points, mst_lc_dist,        CHUNK_SIZE_DIST_ROADS, MCCORS_DIST_ROADS)
