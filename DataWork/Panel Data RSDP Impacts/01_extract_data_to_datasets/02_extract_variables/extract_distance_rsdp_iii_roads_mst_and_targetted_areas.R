...
rsdp_i_iii_roads <- readRDS(file.path(data_file_path, "RSDP Phase I-III Roads and Targetted Locations", "FinalData", 
                                      "roads_rsdp_i_iii.Rds"))

targetted_locations <- readRDS(file.path(data_file_path, "RSDP Phase I-III Roads and Targetted Locations", "FinalData", 
                                      "targetted_locations_unique.Rds"))

mst_euc_dist <- readRDS(file.path(data_file_path, "RSDP Phase I-III Roads and Targetted Locations", "FinalData", 
                                         "rsdpi_iii_targetted_loc_eucdist_mst.Rds"))

mst_lc_dist <- readRDS(file.path(data_file_path, "RSDP Phase I-III Roads and Targetted Locations", "FinalData", 
                                  "rsdpi_iii_targetted_loc_leastcost_mst.Rds"))

##
mst_euc_region_dist <- readRDS(file.path(data_file_path, "RSDP Phase I-III Roads and Targetted Locations", "FinalData", 
                                  "rsdpi_iii_targetted_loc_eucdist_mst_region_appended.Rds"))

mst_lc_region_dist <- readRDS(file.path(data_file_path, "RSDP Phase I-III Roads and Targetted Locations", "FinalData", 
...
# Export -----------------------------------------------------------------------
saveRDS(points@data, file.path(panel_rsdp_imp_data_file_path, DATASET_TYPE, "individual_datasets", "distance_rsdp_iii_roads_mst_and_targetted_areas.Rds"))
