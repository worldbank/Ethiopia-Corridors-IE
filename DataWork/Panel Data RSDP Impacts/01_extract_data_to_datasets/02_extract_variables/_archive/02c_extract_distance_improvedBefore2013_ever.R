...
roads_sdf <- roads_sdf[roads_sdf$Speed2013 > roads_sdf$Speed1996,]
...
points$distance_improved_bf2013_ever <- gDistance_chunks(points, roads_sdf, CHUNK_SIZE_DIST_ROADS)

# Export -----------------------------------------------------------------------
saveRDS(points@data, file.path(finaldata_file_path, DATASET_TYPE, "individual_datasets", "points_distance_improved_bf2013_ever.Rds"))
