...
## Restrict to improved (as of 2012)
roads_sdf <- roads_sdf[roads_sdf$Speed2012 > roads_sdf$Speed1996,]
...
points$distance_anyimproved_by2012 <- gDistance_chunks(points, roads_sdf, CHUNK_SIZE_DIST_ROADS)

# Export -----------------------------------------------------------------------
saveRDS(points@data, file.path(panel_rsdp_imp_data_file_path, DATASET_TYPE, "individual_datasets", "distance_roads_any_improved_by2012.Rds"))
