...
# Load Data --------------------------------------------------------------------
dmspols <- raster(file.path(data_file_path, "Nighttime Lights", "DMSPOLS","RawData", "Stacked", "eth_dmspols_allyears.tif"),1)
eth_adm0 <- readRDS(file.path(data_file_path, "GADM", "RawData", "gadm36_ETH_0_sp.rds"))
...
# Export -----------------------------------------------------------------------
saveRDS(dmspols_points, file.path(panel_rsdp_imp_data_file_path, "dmspols_grid_ethiopia", "individual_datasets","points.Rds"))
saveRDS(dmspols_poly,   file.path(panel_rsdp_imp_data_file_path, "dmspols_grid_ethiopia", "individual_datasets","polygons.Rds"))
