...
saveRDS(kebele_clean, file.path(panel_rsdp_imp_data_file_path, "kebele", "individual_datasets", "polygons.Rds"))
saveRDS(kebele_clean, file.path(panel_rsdp_imp_data_file_path, "kebele", "individual_datasets", "points.Rds"))

## Full Data Files - 1km road not cut of
saveRDS(kebele_blank, file.path(panel_rsdp_imp_data_file_path, "kebele", "individual_datasets", "polygons_no_road_cut.Rds"))
saveRDS(kebele_blank, file.path(panel_rsdp_imp_data_file_path, "kebele", "individual_datasets", "points_no_road_cut.Rds"))
...
saveRDS(kebele@data %>%
          dplyr::select(cell_id,
                        ...
                        Z_CODE,
                        W_CODE,
                        RK_CODE), file.path(panel_rsdp_imp_data_file_path, "kebele", "individual_datasets", "kebele_details.Rds"))
