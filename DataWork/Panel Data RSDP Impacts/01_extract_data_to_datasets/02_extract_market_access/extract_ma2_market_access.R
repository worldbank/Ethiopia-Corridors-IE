...
# Load for UIDs
loc_tt <- readRDS(file.path(panel_rsdp_imp_data_file_path, DATASET_TYPE, "individual_datasets", paste0("ma1_travel_times_for_market_access_",1996,".Rds")))
...
for(year in 1996:2016){
  for(uids_i in orig_uids_list){
    ...
    # Merge in Distance
    distance_df <- readRDS(file.path(panel_rsdp_imp_data_file_path, DATASET_TYPE, "individual_datasets", "ma1_travel_times_for_market_access_lineardist.Rds"))
    ...
    # Export -----------------------------------------------------------------------
    saveRDS(MA_all_df, file.path(panel_rsdp_imp_data_file_path, DATASET_TYPE, "individual_datasets", paste0("ma2_market_access_",year,"_uidgroup",uids_i[1],".Rds")))
