...
#### Load roads
roads_sdf <- readRDS(file.path(project_file_path, "Data", "FinalData", "hypothetical_road_networks", "least_cost_path_mst.Rds"))
...
# Export -----------------------------------------------------------------------
saveRDS(points@data, file.path(finaldata_file_path, DATASET_TYPE, "individual_datasets", "points_distance_least_cost_path_mst.Rds"))
